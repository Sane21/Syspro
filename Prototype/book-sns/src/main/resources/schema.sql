...
CREATE TABLE IF NOT EXISTS bookInfo {
	book_info_id BIGINT NOT NULL AUTO_INGREMENT PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS comments { 
	...
	target_book_id BIGINT NOT NULL REFERENCES KEY book,
	edit_user_id BIGINT NOT NULL REFERENCES KEY users,
...
CREATE TABLE IF NOT EXISTS pastBookInfo{ 
	...
	book_info_id BIGINT NOT NULL REFERENCES KEY bookInfo,
